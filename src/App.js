    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route exact path={`/view/${this.state.notes._id}`} render={() => <NoteView note={this.state.notes[this.noteIndex]} toggleModal={this.toggleModal} handleDeleteNote={this.handleDeleteNote} />} />
